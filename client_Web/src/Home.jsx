...
export default function Home() {
  ...
  return (<>
  {/* page 1 */}
  <div className="w-md bg-red-200 h-screen flex flex-col items-center">
      <div className=" w-md flex flex-col justify-center mt-24">
  ...
  <div className="w-full h-screen  flex flex-col items-center  bg-teal-50">
    <div className="w-[90%] h-full flex flex-col items-center  ">
      <div className=" mr-auto mt-8 flex">
        <Avatar sx={{ width: 160, height: 160 }} src={profile} className="mt-4"/>
        <div className=" break-keep ml-4 text-md">
          ...
          저희 농장에서는  <span className="text-2xl font-bold">토마토</span>를 전문적으로 키우고 있습니다. <br />
        </div>
      </div>
      <div className="text-center w-full  pt-20  text-md leading-relaxed">
          소중한 대저의 흙과 햇살을 담은 이 토마토는 <br /> <span className="font-bold text-xl">짭짤한 맛과 단단한 과육</span>을 가지고 있어요. <br />
          저희 농장에서는 환경과 건강을 위해 <br /> <span className="font-bold text-xl">무농약 재배</span>를 실천하고 있습니다. <br />
        저희는 <span className="font-bold text-xl">엄격한 기준</span>으로 <span className="font-bold text-xl">선별</span>하여 <br />
        고객님께 <span className="font-bold text-xl">최상의 상품</span>만을 <span className="font-bold text-xl">약속</span>드립니다. <br />
